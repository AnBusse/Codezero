 ...
 */
class Version20180521134001 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE comment (pcomment_id VARCHAR(290) NOT NULL, comment VARCHAR(255) NOT NULL, post_id VARCHAR(255) NOT NULL, PRIMARY KEY(pcomment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
